...
(function(){
  // nunca use window.BASE_URL; apenas as variáveis injetadas pelo PHP
  const BASE = window.baseUrl;            // ex: "https://ams.swiss/system"
  const API  = window.FINANCE_PREFIX;     // ex: "https://ams.swiss/system/finance"
  ...
  document.addEventListener('DOMContentLoaded', () => {
    ...
    function openEdit(id) {
      fetch(`${API}/edit?id=${id}`, { credentials: 'same-origin' })

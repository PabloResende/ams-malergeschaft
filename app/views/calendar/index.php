...
<body class="bg-gray-50">
    ...
    <div class="container mx-auto max-w-7xl">
      ...
      <div class="flex flex-col sm:flex-row sm:items-end gap-4 mb-6">
        ...
        <div class="flex justify-end">
          <button id="addReminderBtn" class="w-full sm:w-auto bg-blue-600 hover:bg-blue-700 text-white font-medium px-4 py-2 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
            + Adicionar Lembrete
          </button>
        </div>
      </div>
  ...
  <div id="reminderModal" class="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 hidden z-50">
    <div class="bg-white rounded-lg shadow-xl w-11/12 max-w-md p-6">
      ...
      <form id="reminderForm" class="space-y-4">
        <div>
          ...
          <input type="text" id="reminderTitle" name="title" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:ring-blue-500" required>
        </div>
        <div>
          <label class="block text-sm font-medium text-gray-700">Data</label>
          <input type="date" id="reminderDate" name="reminder_date" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:ring-blue-500" required>
        </div>
        <div>
          <label class="block text-sm font-medium text-gray-700">Cor</label>
          <input type="color" id="reminderColor" name="color" value="#e53e3e" class="mt-1 block w-16 h-10 rounded-md border-gray-300 shadow-sm focus:ring-blue-500">
        </div>
  ...
  <div id="expandedCalendarModal" class="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 hidden z-50">

document.addEventListener('DOMContentLoaded', () => {
    ...
    // Utiliza a variável global baseUrl definida na view
    // const baseUrl já está disponível
    ...
    let reminders = [];
    // Carrega os eventos que vêm do PHP (já processados)
    ...
    // Renderiza calendários para os 12 meses do ano selecionado
    ...
    // Função para carregar e renderizar os calendários com os lembretes atualizados
    ...
    reminderForm.addEventListener('submit', e => {
        ...
        // Debug: imprime os dados do formulário

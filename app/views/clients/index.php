...
<script>
    ...
    editButtons.forEach(button => {
        button.addEventListener('click', function() {
            ...
            document.getElementById('editClientRole').value = this.getAttribute('data-role');
            document.getElementById('editClientBirthDate').value = this.getAttribute('data-birth_date');
            document.getElementById('editClientStartDate').value = this.getAttribute('data-start_date');
            document.getElementById('editClientAddress').value = this.getAttribute('data-address');
            document.getElementById('editClientAbout').value = this.getAttribute('data-about');
            document.getElementById('editClientPhone').value = this.getAttribute('data-phone');
            clientEditModal.classList.remove('hidden');
            document.getElementById('editClientActive').checked = this.getAttribute('data-active') === '1';
        });
    });
